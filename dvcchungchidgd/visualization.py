...
with open('GET_laychungchi.json') as f:
    laychungchi = json.load(f)

with open('GET_laytheomahoso.json') as f:
    laytheomahoso = json.load(f)

with open('GET_laytheosochungchi.json') as f:
    laytheosochungchi = json.load(f)

with open('GET_laytheosochungchicu.json') as f:
    laytheosochungchicu = json.load(f)
...
for i in range(len(themmoi)):
    time.append(laychungchi[i]['time'] + laytheomahoso[i]['time'] + 
                laytheosochungchi[i]['time'] + laytheosochungchicu[i]['time'] +
