...
def get_profile(maHoSo, taskId):
    url = ROOT_URL + "LayTheoMaHoSo?MaHoSo=" + maHoSo + "&TaskId=" + taskId
    data = {}
    headers = {
...
for ob in createData:
    if ("MaHoSo" in ob and "TaskId" in ob):
        get_profile(ob['MaHoSo'], ob['TaskId'])
    else:
        continue

with open('GET_laytheomahosovataskid.json', 'w') as f:
