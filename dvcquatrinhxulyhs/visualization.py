...
with open('GET_laytheomahosovataskid.json') as f:
    laytheomahosovataskid = json.load(f)

with open('GET_laytheomahoso.json') as f:
    laytheomahoso = json.load(f)

with open('GET_laytheotaskid.json') as f:
    laytheotaskid = json.load(f)
...
for i in range(len(themmoi)):
    time.append(laytheomahosovataskid[i]['time'] + laytheomahoso[i]['time'] + 
                laytheotaskid[i]['time'] +
